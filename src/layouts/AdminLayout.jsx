      ...
      `}>
        <div className="h-full flex flex-col p-6">
          ...
          <div className="flex items-center gap-3 mb-10 px-2 text-white">
            ...
            <div>
              <h2 className="font-black text-xl tracking-tighter">SmartPark</h2>
              <p className="opacity-20 text-[10px] font-bold uppercase tracking-widest leading-none">Enterprise CRM</p>
            </div>
          </div>
          ...
          <div className="mt-auto border-t border-white/5 pt-6">
            <NavLink 
              to="/profile"
              className={({ isActive }) => `
                relative bg-white/5 rounded-2xl p-4 flex items-center gap-3 transition-all duration-300 group
                hover:bg-white/10 hover:shadow-lg hover:shadow-brand-primary/5
                ${isActive ? 'ring-1 ring-brand-primary/50 bg-white/[0.08]' : 'border border-transparent'}
              `}
            >
              ...
              <div className="flex-grow overflow-hidden text-left">
                <div className="text-white font-bold text-sm truncate group-hover:text-brand-primary transition-colors">{user.username}</div>
                <div className="text-white/30 text-[10px] font-bold uppercase tracking-widest flex items-center gap-2">
              ...
              <button 
                ...
                className="p-2 text-white/10 hover:text-rose-400 transition-colors relative z-10 hover:scale-110 active:scale-90"
                title={t('logout')}
              >
                <LogOut size={18} />
              </button>
