...
const FeatureCard = ({ icon: Icon, title, description, className = "" }) => (
  ...
  >
    ...
    <div className="mt-8 pt-8 border-t border-white/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-2 text-brand-primary font-bold text-sm">
